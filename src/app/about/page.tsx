...
const teamMembers = [
  {
    ...
    image: "/IMG_4769.JPEG",
    social: {
      instagram: "https://instagram.com/joel",
      twitter: "https://twitter.com/joel",
      linkedin: "https://linkedin.com/in/joel",
      portfolio: "https://joelportfolio.com"
    }
  },
  {
    ...
    social: {
      ...
      portfolio: "https://joshportfolio.com"
    }
  },
  {
    name: "Hasheem",
    ...
    social: {
      instagram: "https://instagram.com/hasheem",
      twitter: "https://twitter.com/hasheem",
      linkedin: "https://linkedin.com/in/hasheem",
      portfolio: "https://hasheemdesign.com"
    }
  },
]
                ...
                >
                  <div className="relative rounded-xl mb-4 h-64 bg-zinc-900 flex items-center justify-center overflow-hidden">
                    ...
                    <motion.div 
                      ...
                      className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end justify-center pb-6"
                    >
                      <div className="flex gap-4">
                        {member.social.instagram && (
                          <a 
                            ...
                            className="p-2 bg-white/10 backdrop-blur-sm rounded-full hover:bg-primary transition-colors duration-300"
                        ...
                        {member.social.twitter && (
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 bg-white/10 backdrop-blur-sm rounded-full hover:bg-blue-400 transition-colors duration-300"
                        ...
                        {member.social.linkedin && (
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 bg-white/10 backdrop-blur-sm rounded-full hover:bg-blue-700 transition-colors duration-300"
                        ...
                        {member.social.portfolio && (
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 bg-white/10 backdrop-blur-sm rounded-full hover:bg-purple-600 transition-colors duration-300"
